...
$page_title = 'Mernis 2015 Ad Soyad Sorgu';
...
<div class="row">
    <div class="col-xl-12 col-md-6">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4"><img style="width: 30px;height: auto;" src="/assets/img/turkey.png" alt=""> Mernis 2015 Ad Soyad Sorgu</h4>
                    ...
                    <div class="block-content tab-content">
                        <div class="tab-pane active" id="tc" role="tabpanel">
                            <form action="mernis2015" method="POST">
                                ...
                                <br>
                                <input autocomplete="off" type="text" name="txtadres" class="form-control" id="numara" placeholder="Adres İl"><br>
                        </div>
