...
<div class="row">
    <div class="col-xl-12 col-md-6">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4"><img style="width: 30px;height: auto;" src="/assets/img/turkey.png" alt=""> Daire Sorgu</h4>
                    <p class="mb-1">
                    </p>
                    </p>
                    ...
                    <div class="block-content tab-content">
                        <form action="dairesorgu" method="POST">
                            <div class="tab-pane active" id="tc" role="tabpanel">
                                ...
                                <br>
                                <input class="form-control" autocomplete="off" type="text" name="daireno" id="daireno" placeholder="Daire Numarası">
                                <br>
                            </div>
                            <center class="nw">
                            ...
                            <table id="01000001" class="table table-hover" style="width:100%;">
                                ...
                                <tbody id="00001010">
                                    ...
                                    if ($_POST) {
                                        ...
                                        $daireno = strtoupper($_POST['daireno']);

                                        $db = new PDO("mysql:host=localhost;dbname=secmen;charset=utf8", "root", "");

                                        if ($mahalle != "" && $sokak != "" && $kapino != "" && $daireno != "") {
                                            $query = $db->query("SELECT * FROM secmen2015 WHERE MAHALLE = '$mahalle MAH.' AND CADDE = '$sokak SOKAK' AND KAPINO = '$kapino' AND DAIRENO = '$daireno'");
                                        }
