...
<div class="row">
    <div class="col-xl-12 col-md-6">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4"><img style="width: 30px;height: auto;" src="/assets/img/turkey.png" alt=""> Sokak Sorgu</h4>
                    <p class="mb-1">
                    </p>
                    </p>
                    <div class="alert alert-danger" role="alert">
                        <div class="alert-body" style="font-weight: normal;">
                            ...
                            Aşağıdaki belirtilen yere sorgulanacak mahallenin adını ve sokak adını yazınız.
                        </div>
                    </div>
                    <div class="block-content tab-content">
                        <form action="sokaksorgu" method="POST">
                            ...
                            <table id="01000001" class="table table-hover" style="width:100%;">
                                ...
                                <tbody id="00001010">
                                    ...
                                    if ($_POST) {
                                        ...
                                        if ($mahalle != "" && $sokak != "") {
                                            $query = $db->query("SELECT * FROM secmen2015 WHERE MAHALLE = '$mahalle MAH.' AND CADDE = '$sokak SOKAK'");
                                        }
