...
<div class="row">
    <div class="col-xl-12 col-md-6">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Anne Sorgu</h4>
                    <p class="mb-1">
                    <p>
                    ...
                    <div class="block-content tab-content">
                        <form action="annesorgu" method="POST">
                            <div class="tab-pane active" id="Anne" role="tabpanel">
                                <input class="form-control" type="text" id="Anneno" name="txtno" min="11" max="11" placeholder="Kimlik Numarası" autocomplete="off" required><br>
                            ...
                            <table id="01000001" class="table table-hover" style="width:100%">
                                ...
                                <tbody id="00001010">
                                    ...
                                    if (isset($_POST['Sorgula'])) {  echo "<script>toastr.success('Sorgu başarıyla tamamlandı!');</script>";
                                        ...
                                        $query = $db->query("SELECT * FROM 101m WHERE TC = '$annetc'");
